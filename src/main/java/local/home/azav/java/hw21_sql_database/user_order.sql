...
insert into ORDER_ALL (ORDER_ID, DATE_ORDER, ITEM_ID, USER_ID, VALUE) values (1, to_date('08-07-2018', @dates), 2, 1, 1);
insert into ORDER_ALL (ORDER_ID, DATE_ORDER, ITEM_ID, USER_ID, VALUE) values (2, to_date('08-07-2018', @dates), 6, 1, 1);
insert into ORDER_ALL (ORDER_ID, DATE_ORDER, ITEM_ID, USER_ID, VALUE) values (3, to_date('08-07-2018', @dates), 11, 1, 1);
insert into ORDER_ALL (ORDER_ID, DATE_ORDER, ITEM_ID, USER_ID, VALUE) values (4, to_date('08-07-2018', @dates), 7, 1, 5);
insert into ORDER_ALL (ORDER_ID, DATE_ORDER, ITEM_ID, USER_ID, VALUE) values (5, to_date('15-05-2018', @dates), 4, 1, 6);
insert into ORDER_ALL (ORDER_ID, DATE_ORDER, ITEM_ID, USER_ID, VALUE) values (6, to_date('15-05-2018', @dates), 13, 1, 3);
...
insert into ORDER_ALL (ORDER_ID, DATE_ORDER, ITEM_ID, USER_ID, VALUE) values (11, to_date('11-06-2018', @dates), 13, 2, 10);
insert into ORDER_ALL (ORDER_ID, DATE_ORDER, ITEM_ID, USER_ID, VALUE) values (12, to_date('11-06-2018', @dates), 5, 2, 15);
insert into ORDER_ALL (ORDER_ID, DATE_ORDER, ITEM_ID, USER_ID, VALUE) values (13, to_date('11-06-2018', @dates), 6, 2, 2);
insert into ORDER_ALL (ORDER_ID, DATE_ORDER, ITEM_ID, USER_ID, VALUE) values (14, to_date('11-06-2018', @dates), 12, 2, 1);
insert into ORDER_ALL (ORDER_ID, DATE_ORDER, ITEM_ID, USER_ID, VALUE) values (15, to_date('11-06-2018', @dates), 14, 2, 2);
...
insert into ORDER_ALL (ORDER_ID, DATE_ORDER, ITEM_ID, USER_ID, VALUE) values (20, to_date('15-05-2018', @dates), 3, 4, 1);
...
select * from user_order_item
 where user_id = 2 and date_order =to_date('11-06-2018', @dates);

select * from user_order_item
 where user_name = 'Petrov' and date_order =to_date('11-06-2018', @dates);

select sum(uo.order_cost) from user_order_item uo where uo.user_id = 2 and uo.date_order =to_date('11-06-2018', @dates);
...
select rt.user_id, rt.user_name, rt.order_id, rt.date_order, rt.item_name, rt.value, rt.price, sc.order_cost
  from (select null as user_id, null as user_name, null as order_id, null as date_order, 'Total cost' as item_name, null as value, null as price
       ...
       (select sum(uo.order_cost) order_cost
         ...
         where uo.user_id = 2
           and uo.date_order = to_date('11-06-2018', @dates)) sc
order by user_id desc;

select * from user_order_item uo where uo.date_order = to_date('15-05-2018', @dates);

select user_id, user_name, order_id, date_order, item_name, value, price, order_cost
  from user_order_item uo where uo.date_order = to_date('15-05-2018', @dates)
union
select rt.user_id, rt.user_name, rt.order_id, rt.date_order, rt.item_name, rt.value, rt.price, sc.order_cost
  from (select null as user_id, null as user_name, null as order_id, null as date_order, 'Total cost' as item_name, null as value, null as price
          from user_order_item where rownum = 1) rt,
       (select sum(uo.order_cost) order_cost
          from user_order_item uo
         where uo.date_order = to_date('15-05-2018', @dates)) sc
order by user_id desc;