...
public class SimpleGetterCounter implements GetterCounter {
    ...
    public static void main(String[] args) {
        ...
        LOG.log(Level.INFO, "sgc PersonAnnotation > {0}", sgc.arrayGetterCount(PersonAnnotation.class));
        LOG.log(Level.INFO, "sgc Person > {0}", sgc.arrayGetterCount(Person.class));
    }
}